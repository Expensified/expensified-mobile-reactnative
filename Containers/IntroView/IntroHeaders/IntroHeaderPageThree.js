...
export default function IntroHeaderPageThree() {
    // JSX for the header of the page
    return (
        <View style={styles.container}>
            <Text style={[styles.header1, styles.header]}>Smart</Text>
            <Text style={[styles.header2, styles.header]}>Categories</Text>
        </View>
    )
}
...
const styles = StyleSheet.create({
    ...
    header1: {
        ...
        : height*(-0.01),
        marginRight: 'auto',
        marginLeft: width < 600 ? width*(0.1067) : 'auto'
    },
    header2: {
        width,
        overflow: 'hidden',
